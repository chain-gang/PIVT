...
```consol
$ helm package prometheus --version <semver>
$ helm upgrade --install prometheus prometheus-<semver> --namespace <namespace>
```
...
```consol
$ helm package prometheus --version <semver>
$ helm upgrade --install prometheus prometheus-<semver> --name my-release --namespace <namespace> 
```
